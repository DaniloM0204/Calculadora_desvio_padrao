...
that uses Numpy to output the mean, variance, standard deviation, 
...
and then return a dictionary containing the mean, variance, standard deviation, max, 
min, and sum along both axes and for the flattened matrix. 
